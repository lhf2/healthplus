...
Look.prototype.render = function () {
    ...
    var that = this;
    this.style && this.$self.find(".look-body").css(this.style);
    if (this.isHideBar) {
        this.hideWindowBar();
    };
...
Look.prototype.setDefaultConfig = function () {
    var body_h = this.$self.find('.look-body').outerHeight() || 0;
...
Look.prototype.autoSize = function () {
    ...
    var head_h = box.find('.look-head').outerHeight() || 0;
    var floor_h = box.find('.look-floor').outerHeight() || 0;
    var box_h = box.outerHeight() || 0;
...
Look.prototype.maxShow = function () {
    ...
    this.$self.find(".look-screen").css("z-index", this.zIndex);
};
